...
<div class="container">
    <div class="row justify-content-center pt-5 pb-5">
        <div class="col-lg-6">
            <h4 class="text-danger text-center pb-3 pt-2">Borrow a book</h4>
            ...
            <div class="card shadow">
                <form action="/reader/borrow-book" method="post">
                    @csrf
                    <div class="pt-5">
                    ...
                    <div class="mb-3 px-5">
                        <label for="exampleFormControlInput2" class="form-label">Check out date</label>
                        <input type="date" name="check_out_date" class="form-control @error('check_out_date') is-invalid @enderror">
                        <small><span class="text-danger">@error('check_out_date'){{ $message }}@enderror</span></small>
                    </div>
                    <div class="mb-3 px-5 pb-4">
                        <input type="submit" class="btn btn-danger w-100" name="check_out" value="Check out">
                    </div>
                </form>
            </div>
        </div>
